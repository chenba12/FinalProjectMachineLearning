...
def main():
    ...
    NOTES:
      ...
      - These are essential for training baseline.py, softmax.py, basic_nn.py,
        cnn_model.py. Later, 'live_inference.py' is used for real-time testing
    ...
    print("Next steps:")
    print("  1) Run 'decision_tree.py'  to train a decision tree model.")
    print("  2) Run 'random_forest.py'  to train a random forest model.")
    print("  3) Run 'basic_nn.py' to train a simple MLP network.")
    print("  4) Run 'cnn_model.py' to train a more complex CNN model.")
